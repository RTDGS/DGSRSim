...
本仓库不直接上传模型权重、训练输出、点云、视频、图片和仿真资产。这些文件不属于当前公开项目地址的内容；是否向编辑部或审稿人单独提供，取决于作者授权、第三方许可和投稿流程要求。

投稿评审期间，公开 GitHub 仓库不提供完整外部资产包、训练输出或原始实验记录，也不在此预留待公布链接。经授权的补充材料或审稿材料与公开项目主页分开交付。
