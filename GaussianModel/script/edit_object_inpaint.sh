...
#python edit_object_inpaint_multi_GPU.py  -m ${output_folder} --config_file ${config_file} ${skip_test}
...
python edit_object_inpaint0.py -m ${output_folder} --config_file ${config_file} ${skip_test}
#!!!记得加--skip_test