...
def parse_args():
    ...
    parser.add_argument(
        "--img_path", type=str, default="./images/1.jpg", help="path to image file"
    )
    ...
    parser.add_argument(
        "--conf", type=float, default=0.01, help="object confidence threshold"
    )
    parser.add_argument(
...
#  # Everything mode
# python Inference.py --model_path weights/FastSAM-x.pt --img_path images/000000.png
