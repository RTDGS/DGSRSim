...
This repository is the public implementation companion to the paper "DGSRSim: An Object-Level Decoupled 3D Gaussian Scene Representation for Robot Simulation and Online State Synchronization". It exposes the paper-aligned algorithms, interfaces, configuration schemas, and selected qualitative media.
